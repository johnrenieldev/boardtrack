 ...
 *
 * UPDATED (Prompt 2):
 *  - Added TOTP / Google Authenticator 2FA methods
 *  - Reads password_hash column (existing behaviour preserved)
 *  - findByEmail() now returns totp_enabled, totp_secret, recovery_codes
